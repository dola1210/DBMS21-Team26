...
$his = mysqli_query($link, "SELECT * FROM history");
$num = mysqli_num_rows($his);
mysqli_query($link, "INSERT INTO history VALUES('$num'+1, '$dist', '$elemen', '$junior', '$senior', '$mrtst', '$mar', '$sc', '$hos')");
...
<html lang="zh-Hant-TW">
	...
	<body>
		<ul>			
			<p align="center"><input type="button" value="繼續搜尋" onclick="location.href='search.php'">  <input type="button" value="回主選單" onclick="location.href='index.php'"></p>
		</ul>
	</body>
</html>
